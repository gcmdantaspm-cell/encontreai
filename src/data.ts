...
export const PROFESSIONALS: Professional[] = [
  ...
  },
  {
    ...
    reviews: [
      { id: 'r3', authorName: 'Beatriz Lima', rating: 5, comment: 'Amei o resultado! Muito caprichosa.', date: 'Há 3 dias' }
    ]
  },
  {
    id: 'p3',
    ...
    description: 'Serviços hidráulicos em geral. Caça-vazamentos, desentupimentos e instalação de tubulações.',
    portfolio: [
      'https://images.unsplash.com/photo-1585644192666-3d239c05e197?q=80&w=600&auto=format&fit=crop'
    ],
    reviews: [
      { id: 'r4', authorName: 'Carlos Eduardo', rating: 4, comment: 'Serviço rápido.', date: 'Há 1 mês' }
    ]
  },
  {
    id: 'p4',
    ...
    description: 'Formatação, remoção de vírus, recuperação de dados e configuração de redes Wi-Fi. Atendimento remoto e presencial.',
    portfolio: [
      'https://images.unsplash.com/photo-1588508065123-287b28e01397?q=80&w=600&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=600&auto=format&fit=crop'
    ],
    reviews: [
      { id: 'r5', authorName: 'Fernando T.', rating: 5, comment: 'Salvou meus arquivos! Recomendo.', date: 'Há 5 dias' }
    ]
  }
];
