...
const targetRegex = /function SearchScreen\(\{[\s\S]*?^function ServiceDetailScreen/m;

const replacement = `function SearchScreen({ pros, isDark, user, toggleFavorite, show }: any) {
